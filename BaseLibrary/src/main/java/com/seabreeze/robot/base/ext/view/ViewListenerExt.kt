...
fun <T : View> T.delayClick(block: (T) -> Unit, delay: Long) =
    setOnClickListener(object : DelayClickListener(delay) {
...
abstract class DelayClickListener(private val delay: Long) : View.OnClickListener {
    ...
    abstract fun onDelayClick(v: View)
