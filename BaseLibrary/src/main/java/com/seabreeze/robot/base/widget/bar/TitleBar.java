...
import com.seabreeze.robot.base.widget.bar.style.LightBarStyle;
import com.seabreeze.robot.base.widget.bar.style.NightBarStyle;
import com.seabreeze.robot.base.widget.bar.style.RippleBarStyle;
import com.seabreeze.robot.base.widget.bar.style.TransparentBarStyle;
...
public class TitleBar extends FrameLayout
    ...
    public TitleBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTitleView.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT, Gravity.CENTER_HORIZONTAL));
        mLeftView.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT, Gravity.START));
        mRightView.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.MATCH_PARENT, Gravity.END));
        mLineView.setLayoutParams(new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, mCurrentStyle.getLineSize(getContext()), Gravity.BOTTOM));
    ...
    public boolean onLongClick(View view) {
        if (mListener != null) {
            if (view == mRightView) {
                mListener.onRightLongClick(view);
                return true;
            }
        }
        return false;
    ...
    public TitleBar setOnTitleBarListener(OnTitleBarListener listener) {
        ...
        mRightView.setOnLongClickListener(this);
        return this;
    }
