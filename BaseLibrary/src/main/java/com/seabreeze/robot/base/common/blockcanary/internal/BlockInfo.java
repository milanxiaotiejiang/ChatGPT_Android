 ...
 */
package com.seabreeze.robot.base.common.blockcanary.internal;
...
import com.seabreeze.robot.base.common.blockcanary.BlockCanaryInternals;
import com.seabreeze.robot.base.ext.device.DeviceIdUtilsKt;
...
public class BlockInfo {
    ...
    static {
        ...
        try {
            sImei = DeviceIdUtilsKt.getDeviceId(
                    BlockCanaryInternals.getContext().provideContext(), false, true, true
            );
