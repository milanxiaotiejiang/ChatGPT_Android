package com.seabreeze.robot.base.widget.edit;
...
public class SplitEditTextView extends AppCompatEditText {
    ...
    private void initAttrs(Context c, AttributeSet attrs) {
        ...
        mCursorColor = array.getColor(R.styleable.SplitEditTextView_splitCursorColor, Color.BLACK);
        mCursorDuration = array.getInt(R.styleable.SplitEditTextView_splitCursorDuration, 500);
        mCursorWidth = array.getDimension(R.styleable.SplitEditTextView_splitCursorWidth, dp2px(2f));
        mCursorHeight = (int) array.getDimension(R.styleable.SplitEditTextView_splitCursorHeight, 0);
