...
inline fun <reified T : Activity> Activity.pop(
    vararg params: Pair<String, Any?>,
    options: Bundle?
) = act.startActivity(createIntent(this, T::class.java, params), options)
...
inline fun <reified T : Activity> Activity.launch(vararg params: Pair<String, Any?>) =
