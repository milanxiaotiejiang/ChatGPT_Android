...
public final class MessagesFixtures extends FixturesData {
    ...
    public static Message getUserTextMessage(String text) {
        User user = new User("0", names.get(0), avatars.get(0), true);
        return new Message(getRandomId(), user, text);
    }

    public static Message getAssistantTextMessage(String text) {
        User user = new User("1", names.get(1), avatars.get(1), true);
        return new Message(getRandomId(), user, text);
    }
