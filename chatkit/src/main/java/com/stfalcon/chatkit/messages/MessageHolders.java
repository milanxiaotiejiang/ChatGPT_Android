...
public class MessageHolders {
    ...
    public interface ContentChecker<MESSAGE extends IMessage> {
         ...
         */
        boolean hasContentFor(@NonNull MESSAGE message, byte type);
    }
    ...
    public static class IncomingTextMessageViewHolder<MESSAGE extends IMessage>
        ...
        @Override
        public void onBind(@NonNull MESSAGE message) {
    ...
    public static class DefaultDateHeaderViewHolder extends ViewHolder<Date>
        ...
        @Override
        public void onBind(@NonNull Date date) {
            if (text != null) {
        ...
        public void onBind(@NonNull MESSAGE message) {
            ...
            if (userAvatar != null) {
                ...
                if (isAvatarExists) {
                    ...
                    imageLoader.loadImage(userAvatar);
                }
            }
        }
