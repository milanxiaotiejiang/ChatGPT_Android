...
import com.seabreeze.robot.base.common.INSTANCE
...
fun Context.sendNotificationMessage(
    ...
    //创建 Notification 栏
    val notification =
        loadNotification(CHAT_CHANNEL_ID, title, message, defaultSoundUri, pendingIntent, icon)
